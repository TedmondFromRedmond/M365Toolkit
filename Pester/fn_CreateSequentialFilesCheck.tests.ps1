...
sl 'C:\Temp\test\M365Toolkit'

cd .\Createmanyfiles
git add .\Createmanyfiles\fn_CreateSequentialFiles.ps1
git add .\Createmanyfiles\Pester
git commit -m "revised function and pester files" 
git push
